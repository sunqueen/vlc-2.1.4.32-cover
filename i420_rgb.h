 ...
 *****************************************************************************/
#ifdef MODULE_NAME_IS_i420_rgb
static void I420_RGB8         ( filter_t *, picture_t *, picture_t * );
static void I420_RGB16_dither ( filter_t *, picture_t *, picture_t * );
static void I420_RGB16        ( filter_t *, picture_t *, picture_t * );
static void I420_RGB32        ( filter_t *, picture_t *, picture_t * );
#else // if defined(MODULE_NAME_IS_i420_rgb_mmx)
static void I420_R5G5B5       ( filter_t *, picture_t *, picture_t * );
static void I420_R5G6B5       ( filter_t *, picture_t *, picture_t * );
static void I420_A8R8G8B8     ( filter_t *, picture_t *, picture_t * );
static void I420_R8G8B8A8     ( filter_t *, picture_t *, picture_t * );
static void I420_B8G8R8A8     ( filter_t *, picture_t *, picture_t * );
static void I420_A8B8G8R8     ( filter_t *, picture_t *, picture_t * );
#endif
...
#define SCALE_WIDTH( cast )                                                   \
    ...
    {                                                                         \
        ...
        p_pic = cast ((uint8_t*)p_pic + i_right_margin );                     \
    }                                                                         \
    else                                                                      \
    {                                                                         \
        /* No scaling, conversion has been done directly in picture memory.   \
         * Increment of picture pointer to end of line is still needed */     \
        p_pic = cast ((uint8_t*)p_pic + p_dest->p->i_pitch );                 \
    }                                                                         \
 ...
 * and 4 Bpp.
 *****************************************************************************/
#define SCALE_HEIGHT( cast, CHROMA, BPP )                                     \
