// sunqueen rename i420_rgb16.c to i420_rgb16.h
/*****************************************************************************
...
//#include "i420_rgb.h"			// sunqueen delete
#if defined (MODULE_NAME_IS_i420_rgb)
#   include "i420_rgb_c.h"
#   define VLC_TARGET
#elif defined (MODULE_NAME_IS_i420_rgb_mmx)
#   include "i420_rgb_mmx.h"	// sunqueen modify
#   define VLC_TARGET VLC_MMX
#elif defined (MODULE_NAME_IS_i420_rgb_sse2)
#   include "i420_rgb_sse2.h"	// sunqueen modify
 ...
 *  - output: 1 line
 *****************************************************************************/
static void I420_RGB16_dither( filter_t *p_filter, picture_t *p_src,
                                                picture_t *p_dest )			// sunqueen modify
{
    ...
    for( i_y = 0; i_y < p_filter->fmt_in.video.i_height; i_y++ )
    {
        ...
        SCALE_WIDTH( (uint16_t *) );			// sunqueen modify
        SCALE_HEIGHT( (uint16_t *), 420, 2 );	// sunqueen modify
...
static void I420_RGB16( filter_t *p_filter, picture_t *p_src, picture_t *p_dest )			// sunqueen modify
{
    /* We got this one from the old arguments */
    uint16_t *p_pic = (uint16_t*)p_dest->p->p_pixels;
    uint8_t  *p_y   = p_src->Y_PIXELS;
...
static void I420_R5G5B5( filter_t *p_filter, picture_t *p_src, picture_t *p_dest )			// sunqueen modify
{
    /* We got this one from the old arguments */
    uint16_t *p_pic = (uint16_t*)p_dest->p->p_pixels;
    uint8_t  *p_y   = p_src->Y_PIXELS;
...
//VLC_TARGET		// sunqueen delete
static void I420_R5G6B5( filter_t *p_filter, picture_t *p_src, picture_t *p_dest )			// sunqueen modify
{
    /* We got this one from the old arguments */
    uint16_t *p_pic = (uint16_t*)p_dest->p->p_pixels;
    uint8_t  *p_y   = p_src->Y_PIXELS;
...
static void I420_RGB32( filter_t *p_filter, picture_t *p_src, picture_t *p_dest )			// sunqueen modify
{
    /* We got this one from the old arguments */
    ...
    for( i_y = 0; i_y < p_filter->fmt_in.video.i_height; i_y++ )
    {
        ...
        SCALE_WIDTH ( (uint32_t *) );			// sunqueen modify
        SCALE_HEIGHT( (uint32_t *), 420, 4 );	// sunqueen modify
...
//VLC_TARGET		// sunqueen delete
static void I420_A8R8G8B8( filter_t *p_filter, picture_t *p_src,
                                            picture_t *p_dest )			// sunqueen modify
{
    /* We got this one from the old arguments */
    uint32_t *p_pic = (uint32_t*)p_dest->p->p_pixels;
...
//VLC_TARGET		// sunqueen delete
static void I420_R8G8B8A8( filter_t *p_filter, picture_t *p_src, picture_t *p_dest )			// sunqueen modify
{
    /* We got this one from the old arguments */
    uint32_t *p_pic = (uint32_t*)p_dest->p->p_pixels;
    uint8_t  *p_y   = p_src->Y_PIXELS;
...
//VLC_TARGET		// sunqueen delete
static void I420_A8B8G8R8( filter_t *p_filter, picture_t *p_src, picture_t *p_dest )			// sunqueen modify
{
    /* We got this one from the old arguments */
    uint32_t *p_pic = (uint32_t*)p_dest->p->p_pixels;
    uint8_t  *p_y   = p_src->Y_PIXELS;
